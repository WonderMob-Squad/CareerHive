<?php
	...
	function getCompanies($major, $degree_level, $job_type, $work_auth) {
		...
		$dbQuery = "SELECT DISTINCT companies.name
					FROM companies, attendants_majors, majors, degree_levels, attendants_degree_levels, job_types, attendants_job_types, work_authorization_types, attendants_work_auth_levels
